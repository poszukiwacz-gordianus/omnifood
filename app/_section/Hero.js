...
export default function Hero() {
  ...
  return (
    <section
      className={`${sticky ? "mt-24" : ""} bg-primary-100 pb-12`}
      id="hero"
    >
      <div className="flex flex-col items-center justify-center gap-10 px-4 text-center sm:p-6 lg:mx-auto lg:grid lg:grid-cols-2 lg:gap-x-6 lg:px-20 lg:text-left xl:gap-20 xl:px-10 xxl:max-w-screen-xl">
